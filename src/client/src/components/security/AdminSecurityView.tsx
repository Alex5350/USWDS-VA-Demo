...
const capabilities: { label: string; permission: Permission }[] = [
  ...
  { label: "Edit case detail", permission: "CanEditCase" },
  { label: "Delete case detail", permission: "CanDeleteCase" },
  ...
  { label: "Create case record", permission: "CanCreateCaseRecord" },
  { label: "Escalate case", permission: "CanEscalateCase" },
